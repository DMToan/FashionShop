...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 04, 2019 at 11:43 PM
...
INSERT INTO `bill_detail` (`id`, `bill_id`, `product_id`, `quantity`) VALUES
(3, 3, 8, 5),
(4, 3, 9, 2);
...
INSERT INTO `bill_list` (`id`, `customer_id`, `add_day`, `delivery_day`, `address`, `status`) VALUES
(3, 2, '2019-01-05', '0000-00-00', '', 0),
(4, 2, '2019-01-05', '0000-00-00', '', 0);
...
(2, 'user', '123', 'user@mail.com', '0123456790', 0);
